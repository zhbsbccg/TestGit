 ...
 if(!querys.equals("1")) {
  if (!fromselfSql.equals(""))
   newsql += " and " + fromselfSql;
	...
	if(!remark.equals("")){
		newsql += " and t1.requestmark like '%"+remark+"%'";
	}
...
RCMenu += "{"+SystemEnv.getHtmlLabelName(364,user.getLanguage())+",WFSearch.jsp?iswaitdo="+iswaitdo+",_self}" ;
RCMenuHeight += RCMenuHeightStep ;
...
<%}%>
  ...
  <tr>
    ...
    <td class=field>
      ...
      <td class=field>
          <button class=browser onClick="onShowDepartment('cdepartmentidspan','cdepartmentid')"></button>
                    ...
                    <tr>
                      ...
                      <td valign="top">                                                                                    
                          ...
                          tableString =" <table instanceid=\"workflowRequestListTable\" tabletype=\"checkbox\" pagesize=\""+perpage+"\" >"+
                                       " <checkboxpopedom    popedompara=\"column:workflowid+column:isremark\" showmethod=\"weaver.general.WorkFlowTransMethod.getWFSearchResultCheckBox\" />"+
