...
String _FnaCtrlBudgetfeeType_hrm_val=Util.null2String(request.getParameter("_FnaCtrlBudgetfeeType_hrm_val"));//是否显示封存科目
...
envelope.addTreeNode(root);*/
	subjectComInfo.getSubjectTreeList(envelope, type,"0",2,filterlevel,filterfeetype,displayarchive,_FnaCtrlBudgetfeeType_hrm_val);

}else{
    subjectComInfo.getSubjectTreeList(envelope,type,id,1,filterlevel,filterfeetype,displayarchive,_FnaCtrlBudgetfeeType_hrm_val);
}
