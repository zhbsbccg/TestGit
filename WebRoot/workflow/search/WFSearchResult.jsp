...
if(fromself.equals("1")) {
  SearchClause.resetClause(); //added by xwj for td2045 on2005-05-26 
    ...
    requestremark=Util.null2String(request.getParameter("requestremark"));
}
else {
...
if(fromself.equals("1")) {
    ...
    if(!requestremark.equals("")){
		newsql += " and t1.requestmark like '%"+requestremark+"%'";
...
<%}%>
  ...
  <tr>
   ...
   <tr>
    <td>单号</td>
    <td class=field>
    	<input name="requestremark" id="requestremark" value="<%=requestremark%>">
